...
skill -> evidence -> how confidently you can talk to it (1 to 5).

Be honest about the 2s and 3s. Those are what `interview-drill` and
`/morning-hunt` step 3 target first.
